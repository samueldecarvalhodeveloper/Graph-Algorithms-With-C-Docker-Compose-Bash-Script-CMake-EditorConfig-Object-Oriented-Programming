#include <vector>
#include "./breadth_first_vertex_edges_searcher.cpp"
...
public:
    ...
    explicit breadth_first_search(const int number_of_vertices)
    {
    ...
    vector<int> get_all_edges(const int vertex)
    {
        ...
        breadth_first_vertex_edges_searcher::search_vertex_all_edges(
            vertex,
            visited_vertices,
